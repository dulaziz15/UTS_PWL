            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="barChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 542px;"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="pieChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 542px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Total Uang yang Dihasilkan: <strong>Rp {{ number_format($totalUangDihasilkan, 0, ',', '.') }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            const tables = [
                { id: 'table-booking', status: 'Booking' },
                { id: 'table-sold', status: 'Sold' }
            ];
        ...
        const donutData = {
            labels: ['Booking', 'Sold', 'Tersedia'],
            datasets: [{
                data: [{{ $jumlahBooking }}, {{ $jumlahSold }}, {{ $jumlahTersedia }}],  // Use the same data for the pie chart
